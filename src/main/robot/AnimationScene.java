...
public class AnimationScene {
    ...
    public AnimationScene() {
        ...
        param[ROBOT_LEAN_S] = create(0.0, DURATION, true, true,
                new double[]{0.0, 0.0, 0.02, -3, 0.04, 3, 0.05, 0, 0.17, 0, 0.18, -3, 0.20, 0, 0.30, 0,
                        0.32, 3, 0.35, 0, 0.40, -10, 0.45, 0, 0.55, 0, 0.60, 10, 0.65, 0, 0.70, 4,
                        0.75, -4, 0.80, 0, 0.90, 0, 0.94, -3, 0.97, 3, 1.0, 0.0});
